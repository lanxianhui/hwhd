...
xml += '</response_define>';
xml += '<response_define>';
xml += '<key_name>KEY_VOL_CHAN</key_name>';
xml += '<response_type>1</response_type>';
xml += '</response_define>';
xml += '<response_define>';
xml += '<key_name>KEY_TRACK</key_name>';
xml += '<response_type>1</response_type>';
xml += '</response_define>';
xml += '<response_define>';
...
xml += '<response_type>1</response_type>';
xml += '<service_url>/EPG/jsp/OneKeySwitch.jsp?ONEKEYSWITCH=vod</service_url>';
xml += '</response_define>';
xml += '<response_define>';			//直播频道地址
xml += '<key_code>KEY_TV_MENU</key_code>';
xml += '<response_type>1</response_type>';
xml += '<service_url>/EPG/jsp/OneKeySwitch.jsp?ONEKEYSWITCH=channel</service_url>';
xml += '</response_define>';
xml += '<response_define>';
xml += '<key_code>KEY_RED</key_code>';     //红色键定义
xml += '<response_type>1</response_type>';
xml += '<service_url>/EPG/jsp/OneKeySwitch.jsp?ONEKEYSWITCH=red</service_url>';
xml += '</response_define>';
xml += '<response_define>';
xml += '<key_code>KEY_GREEN</key_code>';	//绿色键定义
xml += '<response_type>1</response_type>';
xml += '<service_url>/EPG/jsp/OneKeySwitch.jsp?ONEKEYSWITCH=green</service_url>';
xml += '</response_define>';
xml += '<response_define>';
xml += '<key_code>KEY_YELLOW</key_code>';	//黄色键定义
xml += '<response_type>1</response_type>';
xml += '<service_url>/EPG/jsp/OneKeySwitch.jsp?ONEKEYSWITCH=yellow</service_url>';
xml += '</response_define>';
xml += '<response_define>';
xml += '<key_code>KEY_BLUE</key_code>';		//蓝色键定义
xml += '<response_type>1</response_type>';
xml += '<service_url>/EPG/jsp/OneKeySwitch.jsp?ONEKEYSWITCH=blue</service_url>';
xml += '</response_define>';
xml += '<response_define>';
...
xml += '<response_type>1</response_type>';
xml += '<service_url>/EPG/jsp/OneKeySwitch.jsp?ONEKEYSWITCH=favorite</service_url>';
xml += '</response_define>';
xml += '<response_define>';
xml += '<key_code>KEY_NVOD</key_code>';	//轮播定义
xml += '<response_type>1</response_type>';
xml += '<service_url>/EPG/jsp/OneKeySwitch.jsp?ONEKEYSWITCH=nvod</service_url>';
xml += '</response_define>';
xml += '<response_define>';
xml += '<key_code>KEY_SEARCH</key_code>';	//搜索定义
xml += '<response_type>1</response_type>';
xml += '<service_url>/EPG/jsp/OneKeySwitch.jsp?ONEKEYSWITCH=search</service_url>';
xml += '</response_define>';
xml += '<response_define>';
