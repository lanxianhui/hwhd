...
<style type="text/css">
	*{margin:0; padding:0;}
	...
	#background{position:absolute; top:2px; left:499px;  width:284px; height:395px; background:url(images/kanba/select.png) no-repeat; -webkit-transition-duration:0.3s;}
	#cursor{position:absolute; top:3px; left:502px;  width:277px; height:389px; background:url(images/kanba/cursor.png) no-repeat; -webkit-transition-duration:0.3s;}
	#round{position:absolute; top:20px; left:522px;   width:237px; height351px; background:url(images/kanba/round.png) no-repeat; -webkit-transition-duration:0.3s;}
	...
	#name0{top:265px;left:46px;width:89px;}
	#name1{top:280px;left:140px;width: 122px;}
	#name2{top:365px;left:270px;width: 210px;}
	#name3{top:450px;left:510px;width: 263px;}
	#name4{top:365px;left:800px;width:210px;}
	#name5{top:280px;left:1015px;width:122px;}
	#name6{top:265px;left:1140px;width:89px;}
	#name7{width:89px;}

	#shadow0{top:235px;left:46px;width: 89px;height:16px;}
	#shadow1{top:252px;left:140px;width: 122px;height:21px;}
	#shadow2{top:325px;left:270px;width: 210px;height:37px;}
	#shadow3{top:400px;left:510px;width: 263px;height:46px;}
	#shadow4{top:325px;left:800px;width:210px;height:37px;}
	#shadow5{top:252px;left:1015px;width:122px;height:21px;}
	#shadow6{top:230px;left:1140px;width:89px;height:16px;}
	#shadow7{width:89px;height:16px;}
	...
	#kanbalogo {
		...
		width:60px; 
		height:57px; 
		background:url("images/kanba/kanba.png") no-repeat;
	}
</style>
...
// 进入看吧
function doSelect(){
	document.location =   "HD_URLDispatch.jsp?dispatch=" + menu[menuPos].TURNURL +"&fromKanba=1&item=" + menuPos;
}

// 获取json数据
function getSubMenuData(__xmlhttp){
 var data = eval(__xmlhttp.responseText);
	
//	var data	=   [
//	        	     {"TURNURL":"HD_encapsulaUrl.jsp?url=http://61.8.168.194/vasroot/apps/APP_HQ_MTP/",
//	        	    		"NAME":"三屏社区",
//	        	    	    "ITEMICON":"images/kanba/logo/yule.png"},
//	                 {"TURNURL":"HD_encapsulaUrl.jsp?url=http://125.88.96.19:83/vasroot/frame/php4bestv/portal/biz_hq_10026383/1",
//	        	    		 "NAME":"财经看吧",
//	        	    		 "ITEMICON":"images/kanba/logo/caijing.jpg"},	        	    				
//	        	     {"TURNURL":"HD_encapsulaUrl.jsp?url=http://125.88.96.19:83/vasroot/frame/php4bestv/portal/biz_hq_10031626/1",
//	        	    		"NAME":"新闻中心",
//	        	    		"ITEMICON":"images/kanba/logo/xinwenzhongxin.png"},
//	   	        	 {"TURNURL":"HD_encapsulaUrl.jsp?url=http://125.88.96.19:83/vasroot/frame/php4bestv/portal/biz_hq_10061805/1",
//	        	    		"NAME":"超级体育",
//		        	    	"ITEMICON":"images/kanba/logo/chaojitiyu.png"},	        	    		
//			   	     {"TURNURL":"HD_encapsulaUrl.jsp?url=http://125.88.96.19:83/vasroot/frame/php4bestv/portal/biz_hq_10011633/1",
//		        	    	"NAME":"娱乐看吧",
//			        	    "ITEMICON":"images/kanba/logo/yule.png"},			        	    	
//	        	     {"TURNURL":"HD_encapsulaUrl.jsp?url=http://125.88.96.19:83/vasroot/frame/php4bestv/portal/biz_hq_10008070/1",
//			        	    "NAME":"纪实看吧",
//        	    			"ITEMICON":"images/kanba/logo/jishi.png"},  	    	
//   	        	     {"TURNURL":"HD_encapsulaUrl.jsp?url=http://125.88.96.19:83/vasroot/frame/php4bestv//portal/biz_hq_10003424/1",
//			        	    "NAME":"风尚看吧",
//        	    			"ITEMICON":"images/kanba/logo/fengshang.png"},  
//	        	     {"TURNURL":"HD_encapsulaUrl.jsp?url=http://125.88.96.19:83/vasroot/frame/php4bestv/portal/biz_GD_10000347/1",
//	        	    		"NAME":"粤精彩",
//	        	    		"ITEMICON":"images/kanba/logo/yuejingcai.jpg"},
//  	        	     {"TURNURL":"HD_encapsulaUrl.jsp?url=http://125.88.96.19:83/vasroot/frame/php4bestv/portal/biz_hq_10047367/1",
//	        	    		"NAME":"哈哈乐园",
//	        	    		"ITEMICON":"images/kanba/haha.png"}
//	        	    ];
	...
	flag = (menu.length <= image_left.length) ? 0 : 1;
	showImgList();
}

// 数据请求
function ajaxRequest(){
	var requestUrl = "HD_kanBarData.jsp";
	var ajaxObj = new AJAX_OBJ(requestUrl, getSubMenuData);
	ajaxObj.requestData();
...
function changeImg(n) {
	if(moveFlag) return;
	$("background").style.webkitTransitionDuration = duration;
	...
	if(flag == 0) {
		...
		$("title").innerText = nameObj[menuPos].innerText;
		return;
	} else {
...
// imgSide.style.width = "0px";
// nameSide.style.visibility="hidden";
// shadowSide.style.width = "0px";
// imgSide.style.webkitTransitionDuration = "0";
//			
// imgSide.style.height = "0px";
// shadowSide.style.height = "0px";
			...
			setTimeout(function () {  $("background").style.webkitTransitionDuration = "0"; $("background").style.visibility	=	"visible";}, "500");
